...
class JobNumberPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    _clientRequestModel = CreateClientRequestModel(
      ...
      disabilityNumber: oneClientRequest!.disabilityNumber,
      clientNationalNumber: oneClientRequest!.clientNationalNumber,
    );
    return DefaultScaffoldWithCenterLogo(
        //resizeToAvoidBottomInset: true,
      logoUrl: logoUrl,
        body: Container(padding:EdgeInsets.symmetric(horizontal: AppDimension.screenWidth(context)/4) ,
